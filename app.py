...
def submit_new_profile():
    ...
    if request.method == 'POST':
        ...
        plt.title('Your chance of surviving is... \n ' +
...
@app.route('/dhyper.html')
def dhyper():
    return render_template('dhyper.html')
...
@app.route('/auuudio.html')
def auuudio ():
    return render_template('auuudio.html')
...
@app.route('/choice1.html')
def choice1():
    return render_template('choice1.html')

@app.route('/rf3.html')
def rf3():
    return render_template('rf3.html')

@app.route('/rf2.html')
def rf2():
    return render_template('rf2.html')

@app.route('/rf4.html')
def rf4():
    return render_template('rf4.html')

@app.route('/choice2.html')
def choice2():
    return render_template('choice2.html')

@app.route('/story3.html')
def story3():
    return render_template('story3.html')

@app.route('/flare1.html')
def flare1():
    return render_template('flare1.html')

@app.route('/look1.html')
def look1():
...
@app.route('/explore1.html')
def explore1():
    return render_template('explore1.html')

@app.route('/wait2.html')
def wait2():
